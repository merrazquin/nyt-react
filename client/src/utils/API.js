...
export default {
    ...
    getArticles: function (topic, startYear, endYear) {
        ...
        return axios.get(`//api.nytimes.com/svc/search/v2/articlesearch.json?api-key=${process.env.REACT_APP_NYT_API}&fq=document_type:("article")&q=${topic}${begin_date}${end_date}`, {crossDomain: true})
    },
